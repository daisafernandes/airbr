...
export const HealthAlertsCard = ({ alerts, aqiLabel }) => {
    return (_jsxs("div", { className: "bg-card border border-border rounded p-4", children: [_jsxs("div", { className: "flex items-center justify-between mb-3", children: [_jsx("h3", { className: "font-heading text-lg tracking-wide text-foreground", children: "ALERTAS DE SA\u00DADE" }), _jsx("span", { className: "text-[10px] font-mono text-muted-foreground border border-border/50 px-1.5 py-0.5 rounded", children: aqiLabel })] }), alerts.length === 0 ? (_jsx("p", { className: "text-xs text-muted-foreground font-body", children: "Nenhum alerta ativo. Qualidade do ar boa." })) : (_jsx("div", { className: "space-y-2", children: alerts.map((alert, i) => {
