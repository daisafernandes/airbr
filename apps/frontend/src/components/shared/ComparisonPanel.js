...
function TemperatureCompareRow({ valueA, valueB, label, unit, }) {
    const fmt = (v) => v != null && !Number.isNaN(v) ? v.toFixed(1) : '—';
    return (_jsxs("div", { className: "space-y-1", children: [_jsxs("div", { className: "flex items-center justify-between text-[10px] font-mono text-muted-foreground", children: [_jsx("span", { className: "uppercase tracking-wider", children: label }), _jsx("span", { className: "text-[9px]", children: unit })] }), _jsxs("div", { className: "flex items-center gap-2", children: [_jsx("span", { className: "w-10 text-right font-mono text-xs text-primary", children: fmt(valueA) }), _jsx("div", { className: "flex-1 h-px bg-border" }), _jsx("span", { className: "w-10 text-right font-mono text-xs text-yellow-400", children: fmt(valueB) })] })] }));
}
