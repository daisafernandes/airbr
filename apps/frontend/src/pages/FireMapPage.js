...
function ImpactCard({ fireCount, affectedCities, }) {
    return (_jsx("div", { className: "bg-card/90 backdrop-blur-md border border-border rounded-lg p-3 shadow-xl", children: _jsxs("div", { className: "flex items-start gap-2", children: [_jsx(Flame, { className: "w-4 h-4 text-accent mt-0.5 shrink-0" }), _jsxs("p", { className: "text-xs font-body text-foreground leading-snug", children: [_jsx("span", { className: "font-mono font-bold text-accent", children: fireCount }), " focos ativos est\u00E3o afetando a qualidade do ar em", ' ', _jsx("span", { className: "font-mono font-bold text-foreground", children: affectedCities }), " cidades"] })] }) }));
}
function FilterControls({ stateFilter, onStateChange, period, onPeriodChange, showFires, onToggleFires, showDeforestation, onToggleDeforestation, showStations, onToggleStations, }) {
